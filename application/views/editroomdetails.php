...
//$result = $db->query("UPDATE hotelroom SET price=$price,picture=$image where roomID=$roomno and hotelID=$hotelid");

$result =$db->query("UPDATE hotelroom SET price = :price,picture = :picture ,Description = :Description WHERE hotelID = :hotelID 
 and roomID=:roomID" ,array("hotelID"=>$hotelid,"roomID"=>$roomno,"price"=>$price,"picture"=>$image,"Description"=>$description));
	   ...
	   <div class="col-md-8 col-md-offset-2">
			<div class="panel panel-primary" style="margin-top: 10px;">
				<div class="panel-heading">
					<div class = "panel-title"> Room details was updated successfully</div>
				</div>
