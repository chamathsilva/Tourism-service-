	   ...
	   <div class="col-md-8 col-md-offset-2">
			<div class="panel panel-primary" style="margin-top: 10px;">
				<div class="panel-heading">
					<div class = "panel-title"> Edit details of hotel rooms</div>
				</div>
		...
		<div class ="row">
				...
				<form id = "register-form" class="" method="POST" action="editroomdetails.php">
					<div class=" col-md-6 col-md-offset-3">
						...
						<div class = "form-group">
							...
							<input type = "text" name = "roomno" class="form-control" value="" placeholder = "Room No."  required/>
						</div>
						...
						<div class = "form-group">
							...
							<textarea type = "textarea" rows="5" cols="40" id="address" name = "description" class="form-control"  placeholder = "Description" required /></textarea>
						</div>
						
							<div class = "form-group">
							<label for="address">Price Rs.</label>

							<input type = "text" name = "price" class="form-control" value="" placeholder = "Price"  required/>
						</div>
