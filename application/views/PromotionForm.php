        ...
        <div class="panel panel-primary col-md-6 col-md-offset-3 text-center">
            ...
            <form class=""  id="promotion_form" action = "" method = "POST" >
                ...
                <div class = "form-group">
                    ...
                    <input id="offername" type = "text" id = "offername" name = "offername" class="form-control" placeholder="Offer Name" />
                </div>

                <div class = "form-group">
                    <label for="valid">Valid Till</label>
                    <input id="valid" type = "text" id ="valid" name = "valid" class="form-control" placeholder="Valid Till" />
                </div>
                <div class = "form-group">
                    <label for="address">Offer Description</label>

                    <textarea type = "textarea" rows="5" cols="40" id="Info" id = "Info" name = "Info" class="form-control"  placeholder = "Offer Description" /></textarea>
                </div>
